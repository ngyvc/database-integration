...
if ($db_connect) {
    ...
    $sql = "INSERT INTO demo_table (`field1`, `field2`, `field3`, `field4`) VALUES (?,?,?,?)";
    ...
    if ($insertStmt = $db_connect->prepare($sql)) {
        ...
        $insertStmt->bind_param('ssss', $_REQUEST["field1"],  $_REQUEST["field2"],  $_REQUEST["field3"],  $_REQUEST["field4"]); //Here put the code to setup the bind_param
